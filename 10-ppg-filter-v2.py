...
mobility_filter_dir = '{0}/{1}'.format(root_dir, '10. ppg-filter-v2')
# id->value maps
user_id_email_map = {
...
ppg_thresholds = {
    ...
    'laurentkalpers3@gmail.com' : 110000,
...
def get_acc_window_activeness_scores(acc_values, from_ts):  
    activeness_scores = []
    magnitudes = []
            ...
            while timestamp > till_timestamp:
                ...
                if selected_rr_intervals is not None and selected_acc_values is not None and selected_ppg_values is not None:
                    try:
                        ...
                        if get_ppg_stdev(selected_ppg_values) < ppg_threshold:
